...
fields = ["timestamp","tx_id","Mspid", "tx_status", "readkeys", "writekeys", "rangekeys", "transaction_type", "block number", "commit order", "case_id"]
        ...
        with open(file_path) as json_file:
            ...
            try:
                ...
                for x in range(res_len):
                    ...
                    #ires = res[x]['payload']['header']['signature_header']['creator']['IdBytes']
                    #iresstr = bytes(ires).decode("utf8")
                    field_values.append(ires)
                    #print(iresstr)
            except Exception:
                field_values.append("NULL")
